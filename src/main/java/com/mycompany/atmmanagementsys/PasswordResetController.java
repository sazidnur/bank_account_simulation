...
public class PasswordResetController implements Initializable {
    ...
    public void PassReset(ActionEvent event) throws SQLException {
        ...
        Password = "Dear Customer,\nYour password has been successfully changed.\nYour New Password: " + Integer.toString(pass) + "\n\nThanks for using our service!\n    - Admin";
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    if (i > 0) {
                        ...
                        final String username = "kahon.com.bd@gmail.com"; // you have to change your security level
                        final String password = "72885rAtul58827@@";
                        ...
                        try {
                            ...
                            message.setFrom(new InternetAddress("kahon.com.bd@gmail.com"));
                            ...
                            confirmation.setText("Could Not Send The Email , Please Contact With An Admin "+"\n"+ "New Password :"+ pass);
                        }
                    } else {
